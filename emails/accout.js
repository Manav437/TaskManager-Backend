...
export const sendWelcomeEmail = async (email, name) => {
    ...
    try {
        const result = await client.messages.create(process.env.MAILGUN_DOMAIN || 'sandboxb0795a570a2f4344bc39f9698e9ec31f.mailgun.org', data);
...
export const sendDeletionEmail = async (email, name) => {
    ...
    try {
        const result = await client.messages.create('sandboxb0795a570a2f4344bc39f9698e9ec31f.mailgun.org', data)
        console.log('Email sent:', result)
    } catch (e) {
